...
//
//class SkillSetWithSkillsRecyclerAdapter (private val context: Context, private var skillSetsWithSkills: List<SkillSetWithSkills>):
...
//            val skills = skillSetsWithSkills[position]
